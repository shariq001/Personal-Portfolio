    ...
    <div className='xl:min-w-[1440px] sm:min-w-[320px] md:min-w-[768px] lg:min-w-[1024px]'>
      ...
      <div id='work' className='xl:p-[80px] border-[#484848] border-b-[1px] sm:px-[15px] sm:py-[50px] sm:flex sm:flex-col  xl:items-start lg:px-[30px]'>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[80px] md:min-w-[369px] lg:min-w-[450px]'>
          ...
          {/* Right */}
          <div className='xl:p-[50px] xl:max-w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:min-w-[290px] md:min-w-[369px] lg:min-w-[450px]'>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[90px] md:min-w-[369px] lg:min-w-[450px]'>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px] '>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] lg:min-w-[450px] sm:h-[400px] xl:p-[0px] sm:py-[60px] flex justify-center items-center'>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px] '>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[60px] lg:min-w-[450px]'>
      ...
      {/* Section 3 */}
      <div id='about-sec' className='xl:p-[80px] flex md:flex-row xl:justify-between xl:items-center sm:items-start w-full border-[#484848] border-b-[1px] xl:h-[500px] sm:px-[15px] sm:py-[50px] sm:flex-col sm:gap-[30px] sm:justify-start lg:px-[30px]'>
        <h1 className='bebas xl:text-[101px] sm:text-[43px] sm:min-w-[290px] md:min-w-[369px] lg:min-w-[450px] xl:w-[600px]'>ABOUT ME</h1>
        <div className='manrope xl:max-w-[600px] flex flex-col gap-[20px] sm:min-w-[290px] md:min-w-[369px] lg:min-w-[450px]'>
