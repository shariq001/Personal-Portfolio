...
const Home = () => {
  return (
    <div className='xl:min-w-[1440px] sm:min-w-[320px] md:min-w-[768px] lg:min-w-[1024px]'>
      ...
      {/* Section 1 */}
      <div className='xl:p-[80px] flex md:flex-row justify-between w-full md:items-center sm:items-start border-[#484848] border-b-[1px] sm:flex-col sm:gap-[30px] sm:px-[15px] sm:py-[50px] lg:px-[50px]'>

        {/* Left */}
        <div className='flex flex-col gap-[20px] justify-center items-start xl:w-[630px] xl:max-w-[630px] sm:w-full '>
        ...
        {/* Right */}
        <div className='xl:w-[600px] xl:h-[700px] bg-[#1a1a1a] rounded-[10px] sm:w-full  sm:h-[400px] xl:px-[100px] xl:py-[80px] flex justify-center items-center'>
          <Image src='/images/my-pic.jpeg' width={600} height={800} alt='My Pic' className='xl:w-[600px] xl:h-[800px] sm:min-w-[290px] sm:max-w-[300px] sm:h-[300px]'/>
        </div>
      </div>

      {/* Section 2 */}
      <div id='work' className='xl:p-[80px] border-[#484848] border-b-[1px] sm:px-[15px] sm:py-[50px] sm:flex sm:flex-col  xl:items-start lg:px-[50px]'>
        ...
        {/* 1 */}
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>

          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[80px] md:min-w-[369px]'>
            <Image src='/images/project-1.png' width={600} height={600} alt='Project 1' className='xl:w-[600px] xl:h-[400px] rounded-[10px] sm:w-full sm:h-[250px]'/>
          </div>

          {/* Right */}
          <div className='xl:p-[50px] xl:max-w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:min-w-[290px] md:min-w-[369px]'>
            ...
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px] xl:w-[576px] sm:min-w-[290px]'>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[90px] md:min-w-[369px]'>
            <Image src='/images/project2.png' width={600} height={600} alt='Project 2' className='xl:w-[600px] xl:h-[400px] rounded-[10px] sm:w-full sm:h-[250px]'/>
          </div>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px] '>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[400px] xl:p-[0px] sm:py-[60px] flex justify-center items-center'>
            <Image src='/images/project3.png' width={600} height={600} alt='Project 3' className='xl:w-[600px] xl:h-[350px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[250px]'/>
          </div>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px] '>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[60px]'>
            <Image src='/images/project4.png' width={500} height={600} alt='Project 4' className='xl:w-[600px] xl:h-[400px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[250px]'/>
          </div>
          ...
          <div className='xl:p-[50px] xl:max-w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:min-w-[290px] md:min-w-[369px]'>
            ...
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px] xl:w-[576px] sm:min-w-[290px] md:min-w-[369px]'>
              <h3 className='font-semibold  text-white py-[10px]'>PROJECT INFO</h3>
            </div>
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px]  xl:w-[576px] sm:min-w-[290px]'>
              <h3 className='font-semibold  text-white py-[10px]'>Year</h3>
        ...
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px] '>
          ...
          {/* Left */}
          <div className='xl:w-[600px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[60px]'>
            <Image src='/images/project5.png' width={500} height={600} alt='Project 5' className='xl:w-[600px] xl:h-[400px] rounded-[10px] sm:min-w-[290px] md:min-w-[369px] sm:h-[250px]'/>
          </div>
      ...
      {/* Section 3 */}
      <div id='about-sec' className='xl:p-[80px] flex md:flex-row xl:justify-between xl:items-center sm:items-start w-full border-[#484848] border-b-[1px] xl:h-[500px] sm:px-[15px] sm:py-[50px] sm:flex-col sm:gap-[30px] sm:justify-start lg:px-[50px]'>
        <h1 className='bebas xl:text-[101px] sm:text-[43px] sm:min-w-[290px] md:min-w-[369px]'>ABOUT ME</h1>
        <div className='manrope xl:max-w-[704px] flex flex-col gap-[20px] sm:min-w-[290px] md:min-w-[369px] '>
