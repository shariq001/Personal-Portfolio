...
const Home = () => {
  return (
    <div className='xl:min-w-[1440px] sm:min-w-[320px] md:min-w-[768px] lg:min-w-[1024px]'>
      ...
      {/* Section 1 */}
      <div className='xl:p-[80px] flex md:flex-row justify-between w-full md:items-center sm:items-start border-[#484848] border-b-[1px] sm:flex-col sm:gap-[30px] sm:px-[15px] sm:py-[50px] lg:px-[30px]'>

        {/* Left */}
        <div className='flex flex-col gap-[20px] justify-center items-start xl:w-[630px] sm:w-full '>
          ...
          <div className='flex justify-start items-center xl:gap-[16px] sm:gap-[10px]'>
            <Link href='mailto:muhammadshariqfazal@gmail.com' target='_blank'><button type='button' className='bg-[#D3E97A]  manrope rounded-[50px] px-[24px] py-[20px] font-bold text-black sm:text-[14px] xl:text-[16px]'>CONTACT ME <FontAwesomeIcon icon={faCircle} className='xl:size-[12px] lg:inline-flex items-center ml-[15px] sm:hidden md:size-[10px]' /> </button></Link>
      ...
      {/* Section 2 */}
      <div id='work' className='xl:p-[80px] border-[#484848] border-b-[1px] sm:px-[15px] sm:py-[50px] sm:flex sm:flex-col  xl:items-start lg:px-[30px]'>
        <h1 className='xl:text-[78px] bebas text-[#c7c7c7] sm:text-[50px] sm:leading-[90%]'>FEATURED PROJECTS</h1>
        <p className='text-[#c7c7c7] xl:text-[18px] manrope xl:max-w-[600px] sm:text-[16px] sm:min-w-[290px]'>Here are some of the selected projects that <br className='sm:hidden md:block'/> showcase my passion for front-end development.</p>

        {/* 1 */}
        <div className='flex md:flex-row justify-between w-full items-center my-[50px] py-[30px] rounded-[10px] bg-[#1a1a1a] sm:flex-col sm:gap-[30px] md:gap-0'>

          {/* Left */}
          <div className='xl:w-[640px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[80px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px]'>
            <Image src='/images/project-1.png' width={600} height={600} alt='Project 2' className='xl:w-[640px] xl:h-[400px] rounded-[10px] sm:w-full sm:h-[250px] lg:w-[540px]'/>
          </div>

          {/* Right */}
          <div className='xl:p-[50px] xl:min-w-[640px] xl:max-w-[700px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px]'>
            ...
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px] w-full'>
            ...
            <div className='flex justify-start items-center gap-[24px] text-[#D3E97A] xl:w-[576px] sm:w-[290px]'>
        ...
        {/* 2 */}
        <div className='flex md:flex-row justify-between w-full items-center bg-[#1a1a1a] rounded-[10px] my-[50px] py-[30px] sm:flex-col sm:gap-[30px] md:gap-0'>

          {/* Left */}
          <div className='xl:w-[640px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[80px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px]'>
            <Image src='/images/project2.png' width={600} height={600} alt='Project 2' className='xl:w-[640px] xl:h-[400px] rounded-[10px] sm:w-full sm:h-[250px] lg:w-[540px]'/>
          </div>
        ...
        <div className='flex md:flex-row justify-between w-full items-center bg-[#1a1a1a] rounded-[10px] my-[50px] py-[30px] sm:flex-col sm:gap-[30px] md:gap-0'>
          ...
          {/* Left */}
          <div className='xl:w-[640px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px] sm:h-[400px] sm:py-[60px] flex justify-center items-center'>
            <Image src='/images/project3.png' width={600} height={600} alt='Project 3' className='xl:w-[640px] xl:h-[350px] rounded-[10px] sm:min-w-[290px] sm:h-[250px] lg:w-[540px]'/>
          </div>
        ...
        {/* 4 */}
        <div className='flex md:flex-row justify-between w-full items-center bg-[#1a1a1a] rounded-[10px] py-[30px] my-[50px] sm:flex-col sm:gap-[30px] md:gap-0'>

          {/* Left */}
          <div className='xl:w-[640px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[60px] lg:min-w-[450px] lg:max-w-[580px]'>
            <Image src='/images/project4.png' width={500} height={600} alt='Project 4' className='xl:w-[640px] xl:h-[400px] rounded-[10px] sm:min-w-[290px] sm:h-[250px] lg:w-[540px]'/>
          </div>
        ...
        <div className='flex md:flex-row justify-between w-full items-center bg-[#1a1a1a] rounded-[10px] py-[30px] my-[50px] sm:flex-col sm:gap-[30px] md:gap-0 '>
          ...
          {/* Left */}
          <div className='xl:w-[620px] bg-[#1a1a1a] xl:h-[600px] rounded-[10px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] sm:h-[400px] xl:p-[0px] flex justify-center items-center sm:py-[60px] lg:min-w-[450px] lg:max-w-[580px]'>
            <Image src='/images/project5.png' width={500} height={600} alt='Project 5' className='xl:w-[620px] xl:h-[400px] rounded-[10px] sm:min-w-[290px] sm:h-[250px] lg:w-[540px]'/>
          </div>
          ...
          <div className='xl:p-[50px] xl:min-w-[640px] xl:max-w-[700px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px]'>
            ...
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px]  sm:w-full '>
              <h3 className='font-semibold  text-white py-[10px]'>PROJECT INFO</h3>
            </div>
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px]   sm:w-full'>
              <h3 className='font-semibold  text-white py-[10px]'>Year</h3>
            ...
            <div className='flex justify-start items-center gap-[24px] text-[#D3E97A]   sm:w-[290px]'>
      ...
      {/* Section 3 */}
      <div id='about-sec' className='xl:p-[80px] flex md:flex-row md:justify-between xl:items-center sm:items-start w-full border-[#484848] border-b-[1px] xl:h-[500px] sm:px-[15px] sm:py-[50px] sm:flex-col sm:gap-[30px] sm:justify-start lg:px-[30px]'>
        <h1 className='bebas xl:text-[101px] sm:text-[43px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px] xl:min-w-[640px] xl:max-w-[700px]'>ABOUT ME</h1>
        <div className='manrope xl:min-w-[640px] xl:max-w-[700px] flex flex-col gap-[20px] sm:min-w-[290px] md:min-w-[350px] md:max-w-[420px] lg:min-w-[450px] lg:max-w-[580px]'>
