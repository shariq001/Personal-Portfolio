...
const Home = () => {
  return (
    <div className='xl:min-w-[1440px] sm:min-w-[375px]'>
      ...
      {/* Section 1 */}
      <div className='p-[80px] flex xl:flex-row justify-between w-full items-center border-[#484848] border-b-[1px] sm:flex-col sm:gap-[30px] sm:px-[15px]'>

        {/* Left */}
        <div className='flex flex-col gap-[20px] justify-center items-start xl:w-[630px] sm:w-[343px]'>
          ...
          <div className='flex justify-start items-center xl:gap-[16px] sm:gap-[10px]'>
            <Link href=''><button type='button' className='bg-[#D3E97A]  manrope rounded-[50px] px-[24px] py-[20px] font-bold text-black sm:text-[14px] xl:text-[16px]'>CONTACT ME <FontAwesomeIcon icon={faCircle} className='xl:size-[12px] inline-flex ml-[15px] sm:size-[10px]' /> </button></Link>
        ...
        {/* Right */}
        <div className='w-[600px] h-[700px] bg-[#c7c7c7] rounded-[10px] sm:w-[343px] sm:h-[400px]'></div>
      </div>

      {/* Section 2 */}
      <div id='work' className='p-[80px] border-[#484848] border-b-[1px] sm:px-[15px]'>
        <h1 className='xl:text-[78px] bebas text-[#c7c7c7] sm:text-[57px] sm:leading-[90%]'>FEATURED PROJECTS</h1>
        <p className='text-[#c7c7c7] xl:text-[18px] manrope xl:w-[600px] sm:text-[16px] sm:w-[343px]'>Here are some of the selected projects that showcase my passion for front-end development.</p>
        ...
        <div className='flex xl:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>
          ...
          {/* Right */}
          <div className='xl:p-[50px] xl:w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:w-[343px]'>
            ...
            <div className='flex justify-between items-center border-[#c7c7c7] border-b-[1px] xl:w-[576px] sm:w-[343px]'>
            ...
            <div className='flex justify-start items-center gap-[24px] text-[#D3E97A] xl:w-[576px] sm:w-[343px]'>
              <Link href='https://shariq-resume-builder-giaic.vercel.app' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>LIVE DEMO <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
              <Link href='https://github.com/shariq001/GIAIC-Hackathon-1.git' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>SEE ON GITHUB <FontAwesomeIcon icon={faGithub} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
            </div>
          </div>
        </div>

        {/* 2 */}
        <div className='flex xl:flex-row justify-between w-full items-center my-[50px]'>
          ...
          <div className='xl:p-[50px] xl:w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:w-[343px]'>
            ...
            <div className='flex justify-start items-center gap-[24px] text-[#D3E97A] xl:w-[576px] sm:w-[343px]'>
              <Link href='https://3-assignment-eta.vercel.app' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>LIVE DEMO <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
              <Link href='https://github.com/shariq001/q2-assignments.git' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>SEE ON GITHUB <FontAwesomeIcon icon={faGithub} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
            </div>
          </div>
        </div>
        ...
        <div className='flex xl:flex-row justify-between w-full items-center my-[50px] sm:flex-col sm:gap-[30px]'>
          ...
          <div className='xl:p-[50px] xl:w-[600px] flex flex-col gap-[20px] manrope sm:px-[10px] sm:w-[343px]'>
            ...
            <div className='flex justify-start items-center gap-[24px] text-[#D3E97A]  xl:w-[576px] sm:w-[343px]'>
              <Link href='https://9-assignment.vercel.app' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>LIVE DEMO <FontAwesomeIcon icon={faArrowUpRightFromSquare} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
              <Link href='https://github.com/shariq001/q2-assignments.git' target='_blank' className='font-bold py-[5px] border-[#D3E97A] border-b-[2px] xl:text-[16px] sm:text-[14px]'>SEE ON GITHUB<FontAwesomeIcon icon={faGithub} className='size-[15px] inline-flex items-start ml-[8px] mb-[4px]'/></Link>
            </div>
          </div>
        </div>
